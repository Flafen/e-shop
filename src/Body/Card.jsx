...
export function Card({item, gender}) {
  ...
  return (
    <div className={styles.wrapper}>
      <div onClick={setLike} id="heart-id" data-id={item.title} className={styles.like}>{item.liked?<i className="fa-solid fa-heart"></i>:<i className="fa-regular fa-heart"></i>}</div>
